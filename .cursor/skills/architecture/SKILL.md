---
name: architecture
description: Define and reuse the platform architecture for a scalable, modular application. Use when creating architecture docs, establishing system structure, or guiding feature design to stay consistent with the shared platform foundation.
